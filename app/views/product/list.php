...
<body>
    ...
    <a href="/projectbanhang/Product/add">Thêm sản phẩm mới</a>
    <ul>
        <?php foreach ($products as $product): ?>
            <li>
                ...
                <a href="/projectbanhang/Product/edit/<?php echo $product->getID(); ?>">Sửa</a>
                <a href="/projectbanhang/Product/delete/<?php echo $product->getID(); ?>"
